Анна, простите. Я был неправ, когда предложил упрощённый вариант. Настоящая проблема была в кривом форматировании. Сейчас я даю точный, выверенный код README, который будет выглядеть на GitHub идеально.

Замените им старый файл. В блокноте он может показаться немного странным, но GitHub отобразит его правильно. После этого только одна команда для отправки.

### 1. Полный, идеально отформатированный README
